...
int main() {
    ...
    int vertex1, vertex2;
    cout << "Enter the two vertices to check path: ";
    cin >> vertex1 >> vertex2;
    if (G.hasPath(vertex1, vertex2))
        cout << vertex1 << " has path to " << vertex2 << endl;
    else
        cout << vertex1 << " does not have path to " << vertex2 << endl;
