...
SELECT S.itemname
FROM SALES S
         INNER JOIN ITEM I on S.itemname = I.itemname
WHERE I.itemcolor = 'Green';

# 27
SELECT DISTINCT I.*
FROM ITEM I
         INNER JOIN SALES S on I.itemname = S.itemname
...
WHERE E.Deptname != B.Deptname;

# 32
SELECT E.*
FROM EMP E
         INNER JOIN EMP B ON E.Bossno = B.Empno
WHERE E.Empsalary < B.Empsalary / 2;
...
# 69
SELECT S.itemname, S.Deptname, D.Deptfloor, E.Empname
FROM SALES S
         INNER JOIN DEPARTMENT D on S.Deptname = D.Deptname
         INNER JOIN EMP E ON D.MgrId = E.Empno;
