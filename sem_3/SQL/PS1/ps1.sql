...
# QN 9
CREATE TABLE 19PW33_dup_employee AS (SELECT *
                                     FROM 19PW33_employee);
 
# QN 10
ALTER TABLE 19PW33_employee RENAME TO 19PW33_employee_data;
...
# QN 13
INSERT INTO 19PW33_employee_data(EID, Name, Designation, Dept, Salary, City, Phone_number, Date_of_joining)
...
# QN 15
ALTER TABLE 19PW33_employee_data
...
# QN 17
CREATE TABLE 19PW33_CBE_employees AS (SELECT *
                               FROM 19PW33_employee_data
                               WHERE 19PW33_employee_data.City IN ('Coimbatore'));
 
# QN 18
CREATE TABLE 19PW33_Subset_employees AS (SELECT EID, Name, Designation, Phone_number
                                  FROM 19PW33_employee_data);
